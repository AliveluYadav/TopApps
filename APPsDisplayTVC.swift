...
class APPsDisplayTVC: UITableViewController {
    ...
    var urlArryInTbl=[String]()
    var artistArryInTbl=[String]()
    var releaseDatArryInTbl=[String]()
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        appinfo.artistStrng=artistArryInTbl[indexPath.row]
        appinfo.urlStrng=urlArryInTbl[indexPath.row]
        appinfo.relesStrng=releaseDatArryInTbl[indexPath.row]
